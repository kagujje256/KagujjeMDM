...
export default function HomePage() {
  return (
    <div className="min-h-screen hero-pattern">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0F0F1A]/80 backdrop-blur-lg border-b border-[#2D2D4A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              <Link href="#features" className="text-[#B8B8D1] hover:text-[#FF6B35] transition-colors">
                Features
              </Link>
              <Link href="#pricing" className="text-[#B8B8D1] hover:text-[#FF6B35] transition-colors">
                Pricing
              </Link>
              <Link href="#support" className="text-[#B8B8D1] hover:text-[#FF6B35] transition-colors">
                Support
              </Link>
              <Link href="/download" className="text-[#B8B8D1] hover:text-[#FF6B35] transition-colors">
                Download
              </Link>
            </div>
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-[#232340] rounded-full px-4 py-2 mb-8 animate-fadeIn">
            <span className="text-[#00D4AA]">●</span>
            <span className="text-sm text-[#B8B8D1]">Now Available: Desktop App v4.4.2</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-[#B8B8D1] max-w-3xl mx-auto mb-8 animate-fadeIn" style={{ animationDelay: "0.2s" }}>
            Professional Mobile Device Management solutions for technicians.
            <span className="text-[#FF6B35] font-semibold"> 30% cheaper</span> than competitors.
            Built for <span className="text-[#00D4AA] font-semibold">East Africa</span> and the world.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 animate-fadeIn" style={{ animationDelay: "0.4s" }}>
            <div>
              <div className="text-4xl font-bold text-[#FF6B35]">15K+</div>
              <div className="text-[#B8B8D1]">Active Users</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-[#00D4AA]">98%</div>
              <div className="text-[#B8B8D1]">Success Rate</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-[#FF6B35]">100K+</div>
              <div className="text-[#B8B8D1]">Operations</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-[#00D4AA]">24/7</div>
              <div className="text-[#B8B8D1]">Support</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Features Section */}
      <section id="features" className="py-20 px-4 bg-[#232340]/50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
            Powerful Features 💪🏾
          </h2>
          <p className="text-[#B8B8D1] text-center mb-12 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="card hover:scale-105 transition-transform cursor-pointer">
                ...
                <p className="text-[#B8B8D1] text-sm">{feature.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="card">
              ...
              <div className="text-[#B8B8D1] text-sm mb-4">≈ 40,000 UGX</div>
              <div className="text-2xl text-[#00D4AA] font-bold mb-4">25 Credits</div>
              <ul className="space-y-2 mb-6 text-sm text-[#B8B8D1]">
            ...
            <div className="card card-highlight">
              ...
              <div className="text-[#B8B8D1] text-sm mb-4">≈ 65,000 UGX</div>
              <div className="text-2xl text-[#00D4AA] font-bold mb-4">50 Credits</div>
              <ul className="space-y-2 mb-6 text-sm text-[#B8B8D1]">
            ...
            <div className="card">
              ...
              <div className="text-[#B8B8D1] text-sm mb-4">≈ 105,000 UGX</div>
              <div className="text-2xl text-[#00D4AA] font-bold mb-4">100 Credits</div>
              <ul className="space-y-2 mb-6 text-sm text-[#B8B8D1]">
            ...
            {/* Unlimited */}
            <div className="card bg-gradient-to-br from-[#FF6B35]/20 to-[#00D4AA]/20">
              <h3 className="text-xl font-semibold mb-2">Unlimited</h3>
              <div className="text-4xl font-bold mb-1">$35/mo</div>
              <div className="text-[#B8B8D1] text-sm mb-4">≈ 130,000 UGX/mo</div>
              <div className="text-2xl text-[#00D4AA] font-bold mb-4">∞ Credits</div>
              <ul className="space-y-2 mb-6 text-sm text-[#B8B8D1]">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-12">
            <div className="bg-[#232340] px-4 py-2 rounded-lg flex items-center gap-2">
              <span>📱</span>
      ...
      {/* Supported Devices */}
      <section className="py-20 px-4 bg-[#232340]/50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
            Supported Brands 🌍
          </h2>
          <p className="text-[#B8B8D1] text-center mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {["Samsung", "Xiaomi", "OPPO", "Vivo", "Realme", "Tecno", "Infinix", "Nokia", "ZTE", "Motorola", "Huawei", "Google Pixel"].map((brand) => (
              <div key={brand} className="bg-[#2D2D4A] px-6 py-3 rounded-lg hover:bg-[#FF6B35]/20 transition-colors cursor-pointer">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6">
            <div className="card">
              ...
              <p className="text-[#B8B8D1] text-sm">Kampala, Uganda</p>
              <p className="text-[#B8B8D1] text-sm">Serving East Africa & Worldwide</p>
            </div>
            <div className="card">
              <div className="text-2xl mb-2">📧</div>
              <h3 className="font-semibold mb-1">Email</h3>
              <p className="text-[#B8B8D1] text-sm">support@kagujje.com</p>
              <p className="text-[#B8B8D1] text-sm">kaggu@zo.computer</p>
            </div>
            <div className="card">
              <div className="text-2xl mb-2">📱</div>
              <h3 className="font-semibold mb-1">WhatsApp</h3>
              <p className="text-[#B8B8D1] text-sm">+256 702 329 901</p>
              <p className="text-[#B8B8D1] text-sm">24/7 Available</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="py-8 px-4 border-t border-[#2D2D4A]">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="text-[#B8B8D1] text-sm">
              © 2026 Kagujje Inc. All rights reserved.
            </div>
            <div className="flex gap-6">
              <Link href="/terms" className="text-[#B8B8D1] hover:text-[#FF6B35] text-sm">
                Terms
              </Link>
              <Link href="/privacy" className="text-[#B8B8D1] hover:text-[#FF6B35] text-sm">
                Privacy
              </Link>
              <Link href="/reseller" className="text-[#B8B8D1] hover:text-[#FF6B35] text-sm">
                Become a Reseller
              </Link>
            </div>
          </div>
